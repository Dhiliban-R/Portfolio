...
const CERTS = [
    {
        ...
        description: 'Engineered scalable system designs and collaborated in Agile workflows. Spearheaded full-stack feature development mimicking enterprise-level technical lifecycles.',
        date: 'Apr 2025',
        badge: '🎮',
        color: '#14E885',
    ...
    },
    {
        ...
        description: 'Mastered advanced asynchronous execution models, functional programming paradigms, and ES6+ standards for developing heavily optimized, production-grade applications.',
        date: 'May 2024',
        badge: '🌐',
        color: '#f0db4f',
    ...
    },
    {
        ...
        description: 'Applied decoupled software architecture paradigms and clean code practices. Focused heavily on writing maintainable, object-oriented systems that scale linearly.',
        date: 'May 2024',
        badge: '🏗️',
        color: '#0066AE',
